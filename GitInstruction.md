...
В современном мире основная система контроля версий это git, но также есть Mercury, кроме того есть устаревшие системы контроля версий, такие как CVS, SVN, TFS и Subversion
